...
// Registro para HAL
static NetDriver rtl8139_netdrv = {
    "RTL8139",
    rtl8139_init, rtl8139_present,
    rtl8139_send, rtl8139_poll,
    rtl8139_get_mac, rtl8139_set_rx_callback,
};
void rtl8139_register(void) { netdev_register(&rtl8139_netdrv); }
